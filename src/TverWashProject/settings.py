...
SECRET_KEY = 'django-insecure-0tt$^-t=&c739%ak=g9&f21)!m(rhr1s8e8p3eopr#sy)dqm+)'
...
ROOT_URLCONF = 'TverWashProject.urls'
...
WSGI_APPLICATION = 'TverWashProject.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'src/TverWashApp'),
)
